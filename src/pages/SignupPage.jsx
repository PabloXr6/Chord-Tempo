...
const SignupPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up - Chord Tempo</title>
        <meta name="description" content="Create your Chord Tempo account to start building playlists and practicing with our metronome" />
      </Helmet>
      <Header />
